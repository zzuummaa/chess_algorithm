...
use crate::movement::{MoveList, MoveGenerator, Generator};
...
impl ScoreEstimator {
    ...
    pub fn min_max_simple(&mut self, depth: i32, color: Color) -> i32 {
        ...
        // let generator = MoveGenerator::new(&self.board, &self.white_list);
        let mut move_list = MoveList::default();
        unsafe { println!("{:?}", self.white_list.first.as_mut().unwrap().point); }
